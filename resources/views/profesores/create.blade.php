                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{ route('profesores.crear') }}" method="POST" id="form-users">
                                                @csrf
                                                <div class="row">
                                                ...
                                                <div class="row" style="margin-top: 15px;">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group-inner @error('code') input-with-error @enderror">
                                                            ...
                                                            <input type="code" class="form-control" name="code" id="code" value="{{ old('code') }}" required placeholder="{{ __('Code') }}">
                                                            @error('code')
                                                                <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                            @enderror
                                                        </div>
