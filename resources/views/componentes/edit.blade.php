                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="{{ route('componentes.editar',$componente->IdComponent) }}" method="POST">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('name') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="name" id="name" value="{{ old('name') ?? $componente->Name }}">
                                                                @error('name')
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner">
                                                                ...
                                                                <input type="text" class="form-control" name="description" id="description" value="{{ old('description') ?? $componente->Description }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row" style="margin-top: 15px;">
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner">
                                                                <label for="parent">{{ __('Component Parent') }}</label>
