                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        <div class="col-xs-12">
                                                            <div class="form-group-inner @error('description') input-with-error @enderror">
                                                                ...
                                                                <textarea class="form-control" name="description" id="description" rows="3" style="resize: none;">{{ old('description') }}</textarea>
                                                                @error('description')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('modules_number') input-with-error @enderror">
                                                                ...
                                                                <input type="number" class="form-control" name="modules_number" id="modules_number" value="{{ old('modules_number') }}">
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                       <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('modules_format') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="modules_format" id="modules_format" value="{{ old('modules_format') }}">
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('max_file_size') input-with-error @enderror">
                                                                ...
                                                                <input type="number" class="form-control" name="max_file_size" id="max_file_size" value="{{ old('max_file_size') }}">
                                                                @error('max_file_size')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
