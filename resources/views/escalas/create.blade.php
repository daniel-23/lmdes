                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{ route('escalas.crear') }}" method="POST">
                                                @csrf
                                                <div class="row">
                                                ...
                                                <div class="row" style="margin-top: 15px;">
                                                    <div class="col-xs-12">
                                                        <div class="form-group-inner @error('scale') input-with-error @enderror">
                                                            <textarea class="form-control" name="scale" id="scale" rows="5" style="resize: none;" placeholder="{{ __('Scale') }}">{{ old('scale') }}</textarea>
                                                            @error('scale')
                                                                <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                            @enderror
                                                        </div>
