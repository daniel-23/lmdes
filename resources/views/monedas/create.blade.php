                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{ route('monedas.crear') }}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group-inner">
                                                            <input type="text" class="form-control" name="symbol" id="symbol" value="{{ old('symbol') }}" placeholder="{{ __('Symbol') }}">
                                                            @error('symbol')
                                                                <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                            @enderror
                                                        </div>
                                                ...
                                                <div class="row" style="margin-top: 15px;">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group-inner">
                                                            <input type="text" class="form-control" name="prefix" id="prefix" value="{{ old('prefix') }}" placeholder="{{ __('Prefix') }}">
                                                            @error('prefix')
                                                                <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                            @enderror
                                                        </div>
