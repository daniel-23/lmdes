                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('name') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="name" id="name"  value="{{ old('name') ?? $categoria->Name }}">
                                                                @error('name')
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('code') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="code" id="code"  value="{{ old('code') ?? $categoria->Code }}">
                                                                @error('code')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('description') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="description" id="description"  value="{{ old('description') ?? $categoria->Description }}">
                                                                @error('description')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
                                                            ...
                                                            <div class="colorpicker-inner ts-forms mg-b-23">
                                                                <div class="tsbox">
                                                                    ...
                                                                    <label class="color-group" for="palette1">
                                                                        <input type="text" placeholder="#9257b4" id="color" name="color" value="{{ old('color') ?? $categoria->Color }}">
                                                                    </label>
                                                                    @error('color')
                                                                        <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                    @enderror
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('icon') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="icon" id="icon"  value="{{ old('icon') ?? html_entity_decode($categoria->Icon) }}">
                                                                @error('icon')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
