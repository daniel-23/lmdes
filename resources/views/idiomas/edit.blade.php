                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner @error('name') input-with-error @enderror">
                                                                ...
                                                                <input type="text" class="form-control" name="name" id="name" value="{{ old('name') ?? $language->Name }}">
                                                                @error('name')
                                                        ...
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner">
                                                                <label for="route_file">{{ __('Route File') }}</label>
                                                                <input type="text" class="form-control" name="route_file" id="route_file" value="{{ old('route_file') ?? $language->RouteFIle }}">
                                                                @error('route_file')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
                                                    ...
                                                    <div class="row" style="margin-top: 15px;">
                                                        <div class="col-xs-12 col-md-6">
                                                            <div class="form-group-inner">
                                                                ...
                                                                <input type="text" class="form-control" name="prefix" id="prefix" value="{{ old('prefix') ?? $language->Prefix }}">
                                                                @error('prefix')
                                                                    <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                                @enderror
                                                            </div>
