...
<li>
    <a href="{{ route('idiomas') }}">{{ __('Languages') }}</a>
    <span class="bread-slash">/</span>
</li>
<li>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{ route('idiomas.crear') }}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group-inner">
                                                            <input type="text" class="form-control" name="route_file" id="route_file" value="{{ old('route_file') }}" placeholder="{{ __('Route File') }}">
                                                            @error('route_file')
                                                                <span class="help-block small" style="color: red;">{{ __($message) }}</span>
                                                            @enderror
                                                        </div>
