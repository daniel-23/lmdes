                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>{{ __('List') }} <span class="table-project-n">{{ __('users for company') }} {{ $company->Name }}</span>
                                        <a href="{{ route('companies.users.create',$company->IdCompany) }}" class="btn btn-custon-four btn-success">
