                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{ route('permisos.editar',$permiso->IdPermission) }}" method="POST">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group-inner @error('name') input-with-error @enderror">
                                                            <input type="text" class="form-control" name="name" id="name" value="{{ old('name') ?? $permiso->Name }}" placeholder="{{ __('Name') }}">
                                                            @error('name')
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <div class="form-group-inner">
                                                            <input type="text" class="form-control" name="description" id="description" value="{{ old('description') ?? $permiso->Description }}" placeholder="{{ __('Description') }}">
                                                        </div>
                                                    </div>
                                                    <br>&nbsp;
                                                    <div class="col-xs-12">
